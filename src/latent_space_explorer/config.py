...
class Config:
    ...
    def __init__(self):
        ...
        self.dim_reduction_textures_dir = os.path.join(self.out_dir, 'dim_reduction_textures')
        self.reconstructed_meshes_dir = os.path.join(self.out_dir, 'reconstructed_meshes')
        self.plot_dim_reduction_paths = {dim_reduction_type :
                                    os.path.join(self.dim_reduction_textures_dir, f'{dim_reduction_type.name}_plot.png') for dim_reduction_type in DimReductionType}
        self.mesh_paths = {shape_type : os.path.join(self.reconstructed_meshes_dir, f'{shape_type.name}.ply') for shape_type in ShapeType}