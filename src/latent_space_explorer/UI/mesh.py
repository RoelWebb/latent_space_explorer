...
class MeshWidget(QtOpenGL.QGLWidget):
    ...
    def initializeGL(self) -> None:
        ...
        self.prog_shape = IO.load_program(self.ctx, self.shaders_dir_path, 
    ...
    def render_shape_setup(self, angle : float, camera_height : float = 0.4, lookat_height : float = 0.1, height_offset : float = 0.0) -> None:
