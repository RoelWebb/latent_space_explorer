...
class MenuWidget(QWidget):
    ...
    def __init__(self, app_manager : AppManager):
        ...
        self.dim_red_label = QLabel(f'<b>Dimensionality reduction method</b>', self)
        ...
        self.code_space_label = QLabel(f'<b>Shape code space</b>', self)#.setWordWrap(True) 
        ...
        self.selection_only_objects = [self.dim_red_label, self.dim_red_dropdown, self.code_space_label, self.code_space_dropdown, self.select_res_label, self.select_res_slider]
...
class MainWindow(QtWidgets.QWidget): 
    def __init__(self, selection_tab : SelectionWidget, interpolation_tab : InterpolationWidget, menu : MenuWidget, app_manager : AppManager):
        super().__init__() 
