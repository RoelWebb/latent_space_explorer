...
class SelectionWidget(QtWidgets.QWidget):
    ...
    def __init__(self, dim_reduction_widget : DimReductionWidget, code_img_widget : CodeImgWidget, first_mesh_widget : MeshWidget, secondary_mesh_widget : MeshWidget, app_manager : AppManager):
        super().__init__()
