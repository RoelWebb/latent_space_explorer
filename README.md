...
## Acknowledgement
The script [mesh_VARIATION.py](src/latent_space_explorer/utils/mesh_VARIATION.py) is a direct copy of `deep_sdf/mesh.py` from DeepSDF with very minor adjustments.
